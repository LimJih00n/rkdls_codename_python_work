...
def check_out(obj):
    ...
    if obj.get_y() < 40:
        return True
    if obj.get_y() + obj.get_height() > 460:
        return True
    if (obj.get_x() + obj.get_width() > 260 )and ( 210< obj.get_y() < 40) :
        return True
    if (obj.get_x() < 290 ) and (obj.get_y() + obj.get_width() > 260 ) :
        return True
    return False
...
tree3 = world.Wall(315,95,100,105,315,95,50,50,"S",0,0,"default",ids.tree_img_dic)
