...
def check_out(obj):
    if obj.get_x() < 190 :
        return True
    if obj.get_x() + obj.get_width() > 310:
        return True
    if obj.get_y() < 90:
        return True
    if obj.get_y() + obj.get_height() > 350:
        return True
    if (obj.get_x() + obj.get_width() > 260 )and (200< obj.get_y() < 90) :
        return True
    if (obj.get_x() + obj.get_width() > 260 ) and (obj.get_y() > 300) :
        return True
    return False
...
gold1 = world.Item(245,240,50,50,250,250,15,15,"S",0,0,"default",ids.gold_img_dic)
gold2 = world.Item(195,290,50,50,200,300,15,15,"S",0,0,"default",ids.gold_img_dic)
...
tree3 = world.Wall(250,140,100,105,250,150,50,50,"S",0,0,"default",ids.tree_img_dic)
