...
def check_out(obj):
    if obj.get_x() < 90 :
        return True
    if obj.get_x() + obj.get_width() > 360:
        return True
    if obj.get_y() < 40:
        return True
    if obj.get_y() + obj.get_height() > 410:
        return True
    if ( 250 < obj.get_x() <280 )and (  obj.get_y() < 190) :
        return True
    if (obj.get_x() < 250 ) and (obj.get_y() + obj.get_width() > 260 ) :
        return True
    return False
...
def UserLoopCode():
    state = 0 
    if warrior.get_y() == 200 :
       warrior.set_direction("U")
    if warrior.get_x() == 300 :
        #warrior.set_direction("U")
    if warrior.get_y() == 150 :
        warrior.set_direction("D")
...
warrior = world.Hero(205,45,50,50,200,50,20,20,"S",0,0,"default",ids.knight_img_dic)

gold1 = world.Item(290,350,50,50,300,350,15,15,"S",0,0,"default",ids.gold_img_dic)
gold2 = world.Item(290,150,50,50,300,150,15,15,"S",0,0,"default",ids.gold_img_dic)
...
tree2 = world.Wall(320,50,100,105,320,50,50,50,"S",0,0,"default",ids.tree_img_dic)
tree3 = world.Wall(320,95,100,105,320,95,50,50,"S",0,0,"default",ids.tree_img_dic)
castle = world.Wall(255,70,95,65,255,50,95,100,"S",0,0,"default",ids.Castle_img_dic)
#house = world.Wall(300,75,45,65,300,75,45,65,"S",0,0,"default",ids.House_img_dic)
tower = world.Wall(230,330,50,90,230,330,50,50,"S",0,0,"default",ids.Tower_img_dic)
...
# hitbox수정필요!
World_Walls = [tree2,tree3, tower,castle]
world_Items = [gold1,gold2]
World_objects_draw=[
