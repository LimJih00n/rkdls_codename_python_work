...
def check_out(obj):
    ...
    if obj.get_y() < 190:
        return True
    if obj.get_y() + obj.get_height() > 250:
        return True
    return False
...
warrior = world.Hero(100,195,50,50,100,200,20,20,"S",5,5,"default",ids.knight_img_dic)

gold1 = world.Item(350,195,50,50,350,200,15,15,"S",0,0,"default",ids.gold_img_dic)
...
tree3 = world.Wall(375,230,100,110,400,280,50,50,"S",0,0,"default",ids.tree_img_dic)
castle = world.Wall(100,100,100,100,100,100,100,100,"S",0,0,"default",ids.Castle_img_dic)
#house = world.Wall(250,70,50,70,250,70,50,50,"S",0,0,"default",ids.House_img_dic)
tower = world.Wall(300,245,50,95,300,300,50,50,"S",0,0,"default",ids.Tower_img_dic)
...
# hitbox수정필요!
World_Walls = [tree3,castle,tower]
world_Items = [gold1]
World_objects_draw=[
